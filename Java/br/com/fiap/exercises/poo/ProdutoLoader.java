...
public class ProdutoLoader {
    public static void main(String[] args) {
        ...
        System.out.println("Produto com R$200,00 de desconto: R$"+p1.calcularDesconto(200.0));
        ...
        System.out.println("Eletrônico com R$200,00 de desconto: R$"+p1.calcularDesconto(200.0));
